...
//         className={[
//           "ngcc-card",
//           "group relative z-10 flex h-full flex-col overflow-hidden transition-shadow duration-300",
//           CORNER_CLASSES[corner],
...
export type NGCCColor = "cyan" | "pink" | "green" | "amber" | (string & {})
export type NGCCSize = "sm" | "md" | "lg" | "xl"
export type NGCCCorner =
  "bottom-right" | "bottom-left" | "top-right" | "top-left" | "all"
export type NGCCHoverEffect =
      ...
      {features.map((feature) => (
        ...
        >
          <span
            ...
            style={{ backgroundColor: resolvedA }}
          />
          {feature}
        </li>
      ))}

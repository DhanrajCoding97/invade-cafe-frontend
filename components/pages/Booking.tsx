...
export default function BookingSection() {
  ...
  useGSAP(
    () => {
      ...
      const eyebrow = eyebrowLineRef.current;
      ...
      tl.addLabel('headingStart', '-=0.3');

      tl.to(
        linesRef.current.heading ?? [],
        {
          y: '0%',
          duration: 1,
          stagger: 0.1,
      ...
      tl.addLabel('descStart', '-=0.4');

      tl.to(
        linesRef.current.desc ?? [],
        {
          y: '0%',
          duration: 1,
          stagger: 0.1,

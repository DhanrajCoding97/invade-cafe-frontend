  ...
  return (
    ...
    >
      <div className='mx-auto mb-12 max-w-6xl'>
        ...
        <h2
          ref={titleRef}
          className='bg-linear-to-r from-[#28F1FF] to-[#FE11FF] bg-clip-text text-left text-[clamp(2.4rem,.7174rem+3.913vw,3.75rem)] font-extrabold text-transparent [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]'
        >
          Testimonials
        </h2>
        <p
          ref={descRef}
          className='text-left text-[clamp(0.75rem,2vw,1.125rem)] text-[#bcbcbc]'
        >
